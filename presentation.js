...
function showAllData(html) {
  ...
  checkerCountWeatherBlock();
}

function checkerCountWeatherBlock() {
  if (document.querySelector(".blockInfo").children.length > 5) {
    document.querySelector(".blockWeather").remove(0);
  }
}
